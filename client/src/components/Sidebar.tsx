...
const Sidebar = () => {
  ...
  return (
    ...
    border-r border-slate-100 dark:border-slate-800 p-6 transition-colors
    duration-200">
        ...
        <div className="flex flex-col gap-2">
          {navItems.map((item)=>(
            ...
            border-l-3 transition-all duration-200 ${isActive ? 
        ...
        <div className="mt-auto pt-6 border-t border-slate-100 dark:border-slate-800">
          ...
          hover:text-slate-700 dark:hover:text-slate-200 rounded-lg transition-colors duration-200 cursor-pointer">
            {theme === 'light'? <MoonIcon className="size-5"/> : <SunIcon className="
            size-5"/>}
